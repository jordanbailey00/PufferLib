...
/* Reset using a specific runtime loadout id. Invalid ids fall back to the
 * default loadout defined in fc_player_init.h. */
 ...
 * actions[0..FC_NUM_ACTION_HEADS-1] are the canonical backend action heads.
 * The PufferLib adapter currently exposes heads 0-4.
 ...
 */
/* Only available when an optional state-hash implementation is linked. */
#ifndef FC_NO_HASH
